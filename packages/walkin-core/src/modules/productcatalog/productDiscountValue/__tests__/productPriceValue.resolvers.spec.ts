...
import { resolvers as ProductDiscountValueResolver } from "../productDiscountValue.resolvers";
...
const createDiscountType = async manager => {
...
describe("Create discount value", () => {
  test("should create discount value for valid input", async () => {
    ...
    const discountType = await createDiscountType(manager);
    ...
    const productDiscountValue = await ProductDiscountValueResolver.Mutation.createDiscountValueForProduct(
      { user },
      { input: { ...createProductDiscountValue } },
      { injector: ProductDiscountValueModule.injector }
    );
  ...
  test("should create discount value for valid input of price 0", async () => {
    const productInput = {
      name: chance.string(),
      description: chance.string(),
      code: chance.string(),
  ...
  test("should FAIL to create discount value for same channel,store format", async () => {
    const productInput = {
      name: chance.string(),
      description: chance.string(),
      code: chance.string(),
    ...
    try {
      await ProductDiscountValueResolver.Mutation.createDiscountValueForProduct(
        { user },
        { input: { ...createProductDiscountValue } },
        { injector: ProductDiscountValueModule.injector }
      );
...
describe("Update product discount value", () => {
  test("should update a valid product discount value", async () => {
    ...
    const updateProductDiscountValue = await ProductDiscountValueResolver.Mutation.updateDiscountValueForProduct(
      { user },
      {
        input: {
  ...
  test("should update a valid product discount value of  price 0", async () => {
    const productInput = {
      name: chance.string(),
      description: chance.string(),
      code: chance.string(),
...
describe("Fetch product discount Value", () => {
  test("should Create product discount value with valid input", async () => {
    ...
    const getProductDiscountValue = await ProductDiscountValueResolver.Query.productDiscountValue(
      { user },
      {
        filter: { productDiscountValueId: productDiscountValue.id }
      },
      { injector: ProductDiscountValueModule.injector }
    );
  ...
  test("should fetch multiple feedback form", async () => {
    ...
    const getProductDiscountValue = await ProductDiscountValueResolver.Query.productDiscountValues(
      { user },
      {
        filter: {
          productDiscountValueId: productDiscountValue.id
